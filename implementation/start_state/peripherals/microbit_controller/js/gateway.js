...
function toggleConnectionState() {
    ...
    var info = "connecting..";
    // TODO start - formulate and send the HTTP PUT request together with JSON arguments
...
function readLedMatrixState() {
    ...
    var info = "reading..";
    // TODO start - formulate and send the HTTP GET request together with query string arguments
...
function onUpdateLedMatrix() {
    ...
    // TODO start - formulate and send the HTTP PUT request together a JSON object containing arguments bdaddr, handle and hex encoded value.
...
function toggleNotifications() {
    ...
    if (temperature_characteristic.notifying == false || (temperature_characteristic.notifying == true && ws_map.get(handle) === undefined)) {       
        ...
        ws.onopen = function(e) {
            ...
            // TODO start - create a JSON control object with properties bdaddr, handle and command=NOTIFICATIONS_ON and send a string version
            // of it over the web socket
        ...
        ws = ws_map.get(handle);
            ...
            // TODO start - create a JSON control object with properties bdaddr, handle and command=NOTIFICATIONS_OFF and send a string version
            // of it over the web socket, ws
