...
# TODO complete set_state so that generic on off set unack is supported
...
# TODO complete set_state so that light hsl set unack is supported
...
# TODO implement the send_light_hsl_set API function
